...
export default function Aboutme() {
  return (
    <div className="flex items-center gap-y-1 justify-center flex-col">
      <p className="flex items-center justify-center text-[50px] animate-pulse text-neon_green">
        Who am I?
      </p>
      ...
      <div className="mt-20">
        <p className="relative left-5">
          Hello, I am Bilal Küçük, I have been working as a frontend developer
      ...
      <a href="" className="text-neon_green mt-10">
